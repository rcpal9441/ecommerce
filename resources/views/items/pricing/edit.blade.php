...
<!-- 
                ...
                @endif -->
                    ...
                    {{ Form::open(['route' => ['pricing.update','id'=> $topingperdetail->id],'enctype' => 'multipart/form-data', 'class'=>'form_validate']) }}
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="product_id" id="status" onchange="getDensity()">
                                            ...
                                            <option value="{{$product->id}}" @if($topingperdetail->product_id == $product->id) selected="selected" @endif>{{$product->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">Form only (%)</label>
                                        <input type="text" class="form-control" name="Foam_Only" value="{{$topingperdetail->Foam_Only}}" placeholder="Please enter percentage">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="Polycover" value="{{$topingperdetail->Polycover}}"placeholder="Please enter percentage">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="Quilting" value="{{$topingperdetail->Quilting}}"placeholder="Please enter percentage">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="Wool" value="{{$topingperdetail->Wool}}"placeholder="Please enter percentage">
                                    </div>
                                    @if($errors->has('Wool'))
                                        <span class="help-block text-danger">
                                    ...
                                    @endif
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="Vinyle" value="{{$topingperdetail->Vinyle}}"placeholder="Please enter percentage">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="Cotton" value="{{$topingperdetail->Cotton}}"placeholder="Please enter percentage">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="Silk_Fill" value="{{$topingperdetail->Silk_Fill}}"placeholder="Please enter percentage">
                                    </div>
...
function getDensity(){
    ...
    $.ajax({url: location.protocol + '//' + location.host+"/makemyfoamnew/admin/get.product.density?product_id="+product_id, success: function(result){
