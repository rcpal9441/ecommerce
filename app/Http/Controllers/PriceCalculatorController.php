...
class PriceCalculatorController extends Controller
{
    ...
    {
        $products = ToppingPercentage::join('product','product.id','topping_percentage.product_id')
        ->join('product_densities','product_densities.id','topping_percentage.product_density_id')
        ->get(['topping_percentage.*','product.id as product_id','product.name as product_name','product_densities.name as density_name','product_densities.id as product_density_id']);
